...
export default function Industries() {
  ...
  const challenges = [
    { icon: "icons8-nuclear-100.webp", desc: "High color and TDS, poor biodegradability, and sludge-heavy conventional systems." },
    ...
    const electroxHelps = [
    { icon: "icons8-waste-water-100.webp", desc: "~90% removal of colour, dyes, and surfactants from textile streams " },
    { icon: "icons8-nuclear-100.webp", desc: "Lower sludge and salt generation" },
    { icon: "icons8-water-tap-100.webp", desc: "High RO & UF recovery with effective reduction in TH & silica" },
    { icon: "icons8-water-saving-100.webp", desc: "Lower ZLD operations cost, with lower RO reject" }
  ];
