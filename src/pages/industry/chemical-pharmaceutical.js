...
export default function Industries() {
  ...
  const challenges = [
    ...
    { icon: "icons8-waste-water-100.png", desc: "No reuse opportunity of the conventionally treated effluent." }
  ];

    const electroxHelps = [
    { icon: "icons8-water-tap.png", desc: "Breakdown of complex compounds with zero chemicals for primary treatment" },
    { icon: "icons8-water-saving.png", desc: "Effectively absorb pollutant shock loads of up to 300%" },
    { icon: "icons8-waste-water-100.png", desc: "Lower hardness & silica to increase the recovery from UF & RO" },
  ];
