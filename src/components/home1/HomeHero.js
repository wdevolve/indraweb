  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="w-100 text-center flex-grow-1 d-flex flex-column justify-content-center">
            {/* Centered Heading */}
            <h1 className="pb-4 anim-fade-up">
              Smarter Water Starts Here.
            </h1>
          </div>

          {/* Bottom Content */}
          <div className="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-5 w-100 mt-auto border-dark border-top pt-4 pb-5">
