...
export default function TechPeriodicTable() {  
  // useAnimations();
  return (
 <div className="section">
      <div className="container py-5">
        <p className="lead mb-4">The critical metals and minerals involved in our battery recycling, refining, and remanufacturing processes.</p>
        <div className="periodic mt-4">
          <div className="periodic-row">
            <div className="cell" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">
  ...
  <div className="offcanvas-header">
    <h5 className="offcanvas-title" id="offcanvasRightLabel">Lorem Ipsum</h5>
