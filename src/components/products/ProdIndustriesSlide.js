...
export default function ProjIndustriesSlide() {
  // useAnimations();
  const productData = [
  ...
  return (
      <section
        className="d-flex flex-column justify-content-center align-items-center pb-5 position-relative bg-grad-gray-blue" style={{paddingTop:'130px'}}
       >
